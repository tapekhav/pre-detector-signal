...
public:
     ...
     */
    ADC(int resolution, double voltage, double sample_rate);
     ...
     * \param im Vector representing the imaginary part of the complex signal (default is an empty vector for real signals).
     */
    void convertDigitalToAnalog(double sample_rate, const std::vector<double>& re, const std::vector<double>& im = {});
private:
